...
//   // Form 1: Profile Info
//   const { register: registerInfo, handleSubmit: submitInfo, formState: { errors: infoErrors, isSubmitting: infoSubmitting } } = useForm({
...
//       formData.append("fullName", data.fullName, "image", data.profilePicture || "/user.png");
      
//       // Only append image if a new file was selected (we store file in a temp state or refs usually, 
//       // but here let's assume we handle the file input directly via register if simple, 
//       // or use a separate state for the file like in your Feedback modal)
//       if (data.image?.[0]) {
...
//         setUserData(res.data.user); // Update context
//       }
//     } catch (error) {
