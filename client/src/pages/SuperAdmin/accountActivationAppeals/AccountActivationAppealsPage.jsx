...
//             setLoading(true);
//             try {
//                 const res = await axios.get(`${backendUrl}/api/super-admin/appeals`);
//                 if (res.data.success) {
...
//                 action
//             }
//             const res = await axios.post(`${backendUrl}/api/super-admin/resolve-appeal`,
//                 apiData,
...
//                                                         className="px-4 py-3 underline text-blue-500 cursor-pointer">View</td>
...
//                                                             className="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-3 m-2 rounded cursor-pointer">
//                                                             Approve
//                                                         </button>
//                                                         <button
//                                                             onClick={() => resolveAppeal(appeal._id, "reject")}
//                                                             className="bg-red-500 hover:bg-red-600 text-white font-medium px-3 py-2 rounded shadow-md transition cursor-pointer"
//                                                         >
//                                                             Reject
//                                                         </button>
//                                                     </td>
...
//                                     ) : (
//                                         <tr>
//                                             <td colSpan="10" className="text-center py-6 text-gray-500">No Appeal found</td>
//                                         </tr>
//                                     )}
//                             </tbody>
//                         </table>
