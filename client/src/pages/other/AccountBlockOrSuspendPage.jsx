...
// import { Ban, AlertTriangle, Lock, Mail, LogOut } from 'lucide-react';
...
//     // Mock data - In real app, get this from your Context or passed as props
//     // const user = { status: 'suspended', statusMessage: 'Repeated violation of community guidelines in chat.' };
...
//     const theme = {
//         color: isBlocked ? 'text-red-600' : 'text-red-600',
//         bgColor: isBlocked ? 'bg-red-50' : 'bg-red-50',
//         borderColor: isBlocked ? 'border-red-100' : 'border-amber-100',
//         icon: isBlocked ? <Ban className="w-12 h-12 text-red-600" /> : <AlertTriangle className="w-12 h-12 text-red-600" />,
...
//                             className={`w-full flex items-center justify-center gap-2 py-3 px-4 rounded-lg text-white font-semibold transition-colors shadow-sm bg-green-600 hover:bg-green-700 cursor-pointer`}
//                         >
